...
<img src="../images/Numbers/circle-2o.svg" width="24px"> Enter the password accroding to the email-address used as user.
...
<img src="../images/Numbers/circle-3o.svg" width="24px"> Each queue has an own descreption shown in this list. Normally it should be clear enough to identify the queue.
...
The journals included in an export have to be defined in this step. The fiskaltrust.Service devides the journal in several types.
...
**Full export (XML)**<br>
This type is a combination of the eight journals mentioned above. These eight journals are converted to a xml-format containing the same data. This xml-file can be opened as clear text file with every editor. On the other hand the xml is formated in that way, to be ready to open in _Microsoft Excel_ too.
...
Export fiscal archive - Example of fill xml export (code)
